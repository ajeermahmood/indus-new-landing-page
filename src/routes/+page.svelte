	...
	<div class="relative isolate pt-14 lg:px-8 backdrop-blur-sm bg-black/30">
		<div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
			<div class="text-center">
				...
				<p class="mt-6 text-lg leading-8 text-white">Let's find a home that's perfect for you.</p>
				<div class="mt-10 flex items-center justify-center gap-x-6">
					<a
						href="#"
						class="gold-bg rounded-md px-3.5 py-2.5 text-sm font-semibold text-black shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
						>Contact Us</a
					>
...
<div class="flex justify-center">
	<form class="flex flex-row p-5 bg-white relative bottom-14 max-w-5xl rounded-md drop-shadow-lg">
		<div class="flex flex-row max-w-sm">
			<button
				on:click={() => changePropFor('buy')}
				type="button"
				class={propFor == 'buy'
					? 'main-filter-btns-selected w-full border brown-border focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-6 py-2 text-center mr-3 md:mr-1'
					: 'main-filter-btns-unselected w-full border focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-6 py-2 text-center mr-3 md:mr-1'}
				>BUY</button
			>
			<button
